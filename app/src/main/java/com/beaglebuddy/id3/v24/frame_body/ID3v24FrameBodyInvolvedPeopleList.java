 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>involved people list</i> frame body is associated with an ID3v2.4 {@link com.beaglebuddy.id3.enums.v24.FrameType#INVOLVED_PEOPLE_LIST IPLS} {@link com.beaglebuddy.id3.v24.ID3v24Frame frame} which is used to list the people who were involved
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.id3.enums.v24.Encoding encoding}</td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>involved people</i> field.</td></tr>
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may only be one <i>involved people list</i> frame in an ID3v2.4 {@link com.beaglebuddy.id3.v24.ID3v24Tag tag}.
 * </p>
...
public class ID3v24FrameBodyInvolvedPeopleList extends ID3v24FrameBody
{
    ...
    */
   public ID3v24FrameBodyInvolvedPeopleList(Encoding encoding, List<InvolvedPerson> involvedPeople)
   {
    ...
    */
   public ID3v24FrameBodyInvolvedPeopleList(InputStream inputStream, int frameBodySize) throws IOException
   {
