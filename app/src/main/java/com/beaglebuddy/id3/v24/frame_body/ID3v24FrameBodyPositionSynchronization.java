 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>position synchronization</i> frame body is associated with an ID3v2.4 {@link com.beaglebuddy.id3.enums.v24.FrameType#POSITION_SYNCHRONIZATION POSS} {@link com.beaglebuddy.id3.v24.ID3v24Frame frame} which is used to
...
public class ID3v24FrameBodyPositionSynchronization extends ID3v24FrameBody
{
    ...
    */
   public ID3v24FrameBodyPositionSynchronization(InputStream inputStream, int frameBodySize) throws IOException
   {
