 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>terms of use</i> frame body is associated with an ID3v2.4 {@link com.beaglebuddy.id3.enums.v24.FrameType#TERMS_OF_USE USER} {@link com.beaglebuddy.id3.v24.ID3v24Frame frame} which is used to include a brief description of the
 ...
 * {@link ID3v24FrameBodyURLLink Copyright/Legal information} frame.  The <i>terms of use</i> frame body contains the following fields:
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may only be one <i>terms of use</i> frame in an {@link com.beaglebuddy.id3.v24.ID3v24Tag ID3v2.4 tag}.
 * </p>
...
public class ID3v24FrameBodyTermsOfUse extends ID3v24FrameBody
{
    ...
    * @param text       text.
    */
   public ID3v24FrameBodyTermsOfUse(Encoding encoding, Language language, String text)
   {
    ...
    */
   public ID3v24FrameBodyTermsOfUse(InputStream inputStream, int frameBodySize) throws IOException
   {
    ...
    * @param encoding    the character set used to encode the text.  Only those supported by the {@link com.beaglebuddy.id3.enums.v24.Encoding} enum are allowed.
    * @see #getEncoding()
    */
