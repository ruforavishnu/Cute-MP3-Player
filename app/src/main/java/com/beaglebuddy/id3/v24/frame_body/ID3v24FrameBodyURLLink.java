 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>url link</i> frame body is associated with the ID3v2.4 {@link com.beaglebuddy.id3.v24.ID3v24Frame frames} listed below, which contain dynamic data such as webpages with touring
 ...
 * </p>
 * <table class="beaglebuddy">
 * There may only be one <i>url link</i> frame of its kind in a ID3v2.4 {@link com.beaglebuddy.id3.v24.ID3v24Tag tag}, except when stated otherwise in the frame description.
 * </p>
...
public class ID3v24FrameBodyURLLink extends ID3v24FrameBody
{
    ...
    * @param frameType   It must be one of the following 8 ID3v2.4 URL Link frame types:<br/><br/>
    * <table class="beaglebuddy">
    *    <caption><b>ID3v2.4 URL Link Frame Types</b></caption>
    *    <thead>
    ...
    * This constructor is called when creating a new frame.
    * <br/><br/>
    * @param frameType   one of the 8 ID3v2.4 URL Link frame types.  See {@link #ID3v24FrameBodyURLLink(FrameType)}
    * @param url         URL.
    */
   public ID3v24FrameBodyURLLink(FrameType frameType, String url)
   {
      super(frameType);
    ...
    */
   public ID3v24FrameBodyURLLink(InputStream inputStream, FrameType frameType, int frameBodySize) throws IOException
   {
    ...
    * @return a string representation of the ID3v2.4 tag's url link frame.
    */
   @Override
