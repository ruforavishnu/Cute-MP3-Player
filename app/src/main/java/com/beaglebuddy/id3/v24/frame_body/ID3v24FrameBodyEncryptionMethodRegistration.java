 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>encryption method registration</i> frame body is associated with an ID3v2.4 {@link com.beaglebuddy.id3.enums.v24.FrameType#ENCRYPTION_METHOD_REGISTRATION ENCR} {@link com.beaglebuddy.id3.v24.ID3v24Frame frame} which is used to identify with which method a frame
 ...
 * </p>
 * <p>
 * There may be more than one <i>encrypted method registration</i> frame in an ID3v2.4 {@link com.beaglebuddy.id3.v24.ID3v24Tag tag}, but only one with the same method
...
public class ID3v24FrameBodyEncryptionMethodRegistration extends ID3v24FrameBody
{
    ...
    */
   public ID3v24FrameBodyEncryptionMethodRegistration(String ownerId, byte methodSymbol, byte[] data)
   {
    ...
    */
   public ID3v24FrameBodyEncryptionMethodRegistration(InputStream inputStream, int frameBodySize) throws IOException
   {
