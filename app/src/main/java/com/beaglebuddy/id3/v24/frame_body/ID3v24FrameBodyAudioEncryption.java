 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>audio encryption</i> frame body is associated with an ID3v2.4 {@link com.beaglebuddy.id3.enums.v24.FrameType#AUDIO_ENCRYPTION AENC} {@link com.beaglebuddy.id3.v24.ID3v24Frame frame} which is used to indicate if any part, or all, of the actual audio
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one audio encryption frame in an ID3v2.4 {@link com.beaglebuddy.id3.v24.ID3v24Tag tag}, but only one with the same <i>ownerId</i> field.
 * </p>
...
public class ID3v24FrameBodyAudioEncryption extends ID3v24FrameBody
{
    ...
    */
   public ID3v24FrameBodyAudioEncryption(String ownerId, int previewStart, int previewLength, byte[] encrcrytpionInfo)
   {
    ...
    */
   public ID3v24FrameBodyAudioEncryption(InputStream inputStream, int frameBodySize) throws IOException
   {
   ...
   public String toString()
   {
      ...
      buffer.append("                      " + hex(encrcrytpionInfo, 24) + "\n");
