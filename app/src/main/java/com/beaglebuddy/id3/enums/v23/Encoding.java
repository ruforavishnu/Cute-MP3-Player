 ...
 * The ID3v2.3 specification allows only two of these encodings to be used.
...
{                                                              /** standard ascii character set */
   ISO_8859_1("ISO-8859-1", Charset.forName("ISO-8859-1"), 1), /** 2 byte unicode character set with BOM (0xFF 0xFE) */
    ...
    * @return the ID3v2.3 Encoding enum corresponding to the integral value.
    * @param encoding  integral value to be converted to an ID3v2.3 Encoding enum.
    * @throws IllegalArgumentException   if the integral value does not correspond to a valid ID3v2.3 Encoding.
    */
   public static Encoding valueOf(byte encoding) throws IllegalArgumentException
   {
      for (Encoding e : Encoding.values())
         if (encoding == e.ordinal())
            return e;
      throw new IllegalArgumentException("Invalid ID3v2.3 encoding " + encoding + ".  It must be either 0 or 1.");
   }
