 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>user defined text information</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.id3.enums.v23.FrameType#USER_DEFINED_TEXT_INFORMATION TXXX} {@link com.beaglebuddy.id3.v23.ID3v23Frame frame} which is used to include one-string text
 * information concerning the audio file in a similar way to the other {@link ID3v23FrameBodyTextInformation text information} frames. The <i>user defined text information</i> frame body
 ...
 * </table>
 * <p class="beaglebuddy">
 * There may be more than one <i>user defined text information</i> frame in an ID3v2.3 {@link com.beaglebuddy.id3.v23.ID3v23Tag tag}, but only one with the same <i>description</i> field.
 * </p>
...
public class ID3v23FrameBodyUserDefinedTextInformation extends ID3v23FrameBody
{
    ...
    * @param text           text;
    */
   public ID3v23FrameBodyUserDefinedTextInformation(Encoding encoding, String description, String text)
   {
    ...
    */
   public ID3v23FrameBodyUserDefinedTextInformation(InputStream inputStream, int frameBodySize) throws IOException
   {
    ...
    * @param encoding    the character set used to encode the description and the text. Only those supported by the {@link com.beaglebuddy.id3.enums.v23.Encoding} enum are allowed.
    * @see #getEncoding()
    */
