 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>reverb</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.id3.enums.v23.FrameType#REVERB RVRB} {@link com.beaglebuddy.id3.v23.ID3v23Frame frame} which is used to adjust echoes of different kinds when
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may only be one <i>reverb</i> frame in an ID3v2.3 {@link com.beaglebuddy.id3.v23.ID3v23Tag tag}.
 * </p>
...
public class ID3v23FrameBodyReverb extends ID3v23FrameBody
{
    ...
    */
   public ID3v23FrameBodyReverb(int left, int right, byte leftBounces, byte rightBounces, byte feedbackLeftToLeft, byte feedbackLeftToRight, byte feedbackRightToRight, byte feedbackRightToLeft,
    ...
    */
   public ID3v23FrameBodyReverb(InputStream inputStream, int frameBodySize) throws IOException
   {
