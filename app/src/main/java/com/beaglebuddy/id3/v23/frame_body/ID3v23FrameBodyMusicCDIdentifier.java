 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>music CD identifier</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.id3.enums.v23.FrameType#MUSIC_CD_IDENTIFIER MCDI} {@link com.beaglebuddy.id3.v23.ID3v23Frame frame} which is used to identify .mp3 songs that are ripped
 ...
 * absolute CD-frame address per track, and not with absolute time. This frame requires a present and valid {@link ID3v23FrameBodyTextInformation Track} frame, even if the CD's only got one track.
...
public class ID3v23FrameBodyMusicCDIdentifier extends ID3v23FrameBody
{
    ...
    */
   public ID3v23FrameBodyMusicCDIdentifier(InputStream inputStream, int frameBodySize) throws IOException
   {
