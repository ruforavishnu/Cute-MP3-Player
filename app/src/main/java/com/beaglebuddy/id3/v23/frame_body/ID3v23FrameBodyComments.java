 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>comments</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.id3.enums.v23.FrameType#COMMENTS COMM} {@link com.beaglebuddy.id3.v23.ID3v23Frame frame} which is intended for any kind of full text information that does not fit
 ...
 * </table>
 * <p class="beaglebuddy">
 * There may be more than one <i>comment</i> frame in an ID3v2.3 {@link com.beaglebuddy.id3.v23.ID3v23Tag tag}, but only one with the same <i>language</i> and
...
public class ID3v23FrameBodyComments extends ID3v23FrameBody
{
    ...
    */
   public ID3v23FrameBodyComments(Encoding encoding, Language language, String description, String text)
   {
    ...
    */
   public ID3v23FrameBodyComments(InputStream inputStream, int frameBodySize) throws IOException
   {
