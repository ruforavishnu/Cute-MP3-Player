 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>event timing codes</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.id3.enums.v23.FrameType#EVENT_TIMING_CODES ETCO} {@link com.beaglebuddy.id3.v23.ID3v23Frame frame} which is used to synchronize key events in a song.
 ...
 * </table>
 * <p class="beaglebuddy">
 * There may be only one <i>event timing codes</i> frame in an ID3v2.3 {@link com.beaglebuddy.id3.v23.ID3v23Tag tag}.
 * </p>
...
public class ID3v23FrameBodyEventTimingCodes extends ID3v23FrameBody
{
    ...
    */
   public ID3v23FrameBodyEventTimingCodes(TimeStampFormat timeStampFormat, List<EventCode> eventCodes)
   {
    ...
    */
   public ID3v23FrameBodyEventTimingCodes(InputStream inputStream, int frameBodySize) throws IOException
   {
