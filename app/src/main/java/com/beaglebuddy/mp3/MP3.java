...
public class MP3 extends MP3Base
{
    ...
    * <br/><br/><b>Example:</b><code><pre class="beaglebuddy">
    *     // load the song "Pas Plus de Seize Ans" from Voie de Fait's "Ange ou Dmon" album.
    *     MP3 mp3 = new MP3("c:/mp3/voie de fait/ange ou dmon/pas plus de seize ans.mp3");
    ...
    *     mp3.setComments("Das Lied gefllt mir");        // write a comment in german  - overwrites the previous english comment
    *     mp3.setComments("Me gusta esta Cancin");       // write a comment in spanish - overwrites the previous german  comment
    *     System.out.println("the song " + mp3.getTitle() + " has a comment: " + mp3.getComments());</pre></code>
    ...
    * @see #setSynchronizedLyrics(Language, SynchronizedLyric [])
