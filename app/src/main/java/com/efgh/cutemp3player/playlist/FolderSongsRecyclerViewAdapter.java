...
public  class FolderSongsRecyclerViewAdapter extends RecyclerView.Adapter<FolderSongsRecyclerViewAdapter.ViewHolder>
{
    ...
    public FolderSongsRecyclerViewAdapter(List<MP3MetaData> myDataset)
    {
    ...
    @Override
    public synchronized FolderSongsRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,int viewType)
    {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.foldersrecyclerview_layout, parent, false);
